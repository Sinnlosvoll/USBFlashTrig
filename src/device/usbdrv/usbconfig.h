 ...
 */
#define USB_CFG_VENDOR_NAME     'k', 'a', 'r', 't', 'o', 'f', 'f', 'e', \
								'l', 'k', 'e', 'k', 's', 'e', '.', 'o',\
								'r', 'g'
 ...
 * details.
 */
#define USB_CFG_DEVICE_NAME     'f', 'l', 'a', 's', 'h', 't', 'r', 'i', \
								'g'
...
#define USB_CFG_INTERFACE_SUBCLASS  0x00 // none
#define USB_CFG_INTERFACE_PROTOCOL  0x00 // none 
